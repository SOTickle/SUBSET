source('BinWeight.R')
source('BinWeight_penalty.R')
source('inspect_AMOC.R')
source('inspect_AMOC_penalty.R')
source('madcorrection.R')
source('Max.R')
source('Max_penalty.R')
source('Mean.R')
source('Mean_penalty.R')
source('SUBSET_negbin.R')
source('SUBSET_negbin_penalty.R')
source('SUBSET_normal.R')
source('SUBSET_normal_penalty.R')
